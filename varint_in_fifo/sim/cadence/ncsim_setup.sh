...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../fifo_160/sim/varint_in_fifo_fifo_160_v2ho2aa.v" -work varint_in_fifo_fifo_160 -cdslib ./cds_libs/varint_in_fifo_fifo_160.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/varint_in_fifo.v"                                                                                                                  
fi
