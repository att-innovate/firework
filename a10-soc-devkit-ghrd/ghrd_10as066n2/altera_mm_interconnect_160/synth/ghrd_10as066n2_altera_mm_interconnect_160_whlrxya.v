// ghrd_10as066n2_altera_mm_interconnect_160_whlrxya.v
...
`timescale 1 ps / 1 ps
module ghrd_10as066n2_altera_mm_interconnect_160_whlrxya (
	...
	ghrd_10as066n2_altera_merlin_router_160_goq5gdi router (
	...
	ghrd_10as066n2_altera_merlin_router_160_hdzb36q router_001 (
	...
	ghrd_10as066n2_altera_merlin_router_160_hdzb36q router_002 (
	...
	ghrd_10as066n2_altera_merlin_router_160_hdzb36q router_003 (
	...
	ghrd_10as066n2_altera_merlin_router_160_hdzb36q router_004 (
	...
	ghrd_10as066n2_altera_merlin_router_160_hdzb36q router_005 (
	...
	ghrd_10as066n2_altera_merlin_demultiplexer_160_lj6xvjq cmd_demux (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (pb_lwh2f_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ghrd_10as066n2_altera_merlin_multiplexer_160_dxv5bzy cmd_mux (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (pb_lwh2f_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ghrd_10as066n2_altera_merlin_multiplexer_160_dxv5bzy cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (pb_lwh2f_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ghrd_10as066n2_altera_merlin_multiplexer_160_dxv5bzy cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (pb_lwh2f_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ghrd_10as066n2_altera_merlin_multiplexer_160_dxv5bzy cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (pb_lwh2f_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ghrd_10as066n2_altera_merlin_multiplexer_160_dxv5bzy cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (pb_lwh2f_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ghrd_10as066n2_altera_merlin_demultiplexer_160_k452t3q rsp_demux (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (pb_lwh2f_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ghrd_10as066n2_altera_merlin_demultiplexer_160_k452t3q rsp_demux_001 (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (pb_lwh2f_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ghrd_10as066n2_altera_merlin_demultiplexer_160_k452t3q rsp_demux_002 (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (pb_lwh2f_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ghrd_10as066n2_altera_merlin_demultiplexer_160_k452t3q rsp_demux_003 (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (pb_lwh2f_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ghrd_10as066n2_altera_merlin_demultiplexer_160_k452t3q rsp_demux_004 (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (pb_lwh2f_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ghrd_10as066n2_altera_merlin_multiplexer_160_iltwdfa rsp_mux (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (pb_lwh2f_reset_reset_bridge_in_reset_reset), // clk_reset.reset
