// ghrd_10as066n2_altera_mm_interconnect_160_bristfa.v
...
`timescale 1 ps / 1 ps
module ghrd_10as066n2_altera_mm_interconnect_160_bristfa (
		...
		input  wire         f2sdram_only_master1_clk_reset_reset_bridge_in_reset_reset, // f2sdram_only_master1_clk_reset_reset_bridge_in_reset.reset
		input  wire [31:0]  f2sdram_only_master1_master_address,                        //                          f2sdram_only_master1_master.address
		output wire         f2sdram_only_master1_master_waitrequest,                    //                                                     .waitrequest
		input  wire [3:0]   f2sdram_only_master1_master_byteenable,                     //                                                     .byteenable
		input  wire         f2sdram_only_master1_master_read,                           //                                                     .read
		output wire [31:0]  f2sdram_only_master1_master_readdata,                       //                                                     .readdata
		output wire         f2sdram_only_master1_master_readdatavalid,                  //                                                     .readdatavalid
		input  wire         f2sdram_only_master1_master_write,                          //                                                     .write
		input  wire [31:0]  f2sdram_only_master1_master_writedata                       //                                                     .writedata
	);

	wire          f2sdram_only_master1_master_translator_avalon_universal_master_0_waitrequest;   // f2sdram_only_master1_master_agent:av_waitrequest -> f2sdram_only_master1_master_translator:uav_waitrequest
	wire   [31:0] f2sdram_only_master1_master_translator_avalon_universal_master_0_readdata;      // f2sdram_only_master1_master_agent:av_readdata -> f2sdram_only_master1_master_translator:uav_readdata
	wire          f2sdram_only_master1_master_translator_avalon_universal_master_0_debugaccess;   // f2sdram_only_master1_master_translator:uav_debugaccess -> f2sdram_only_master1_master_agent:av_debugaccess
	wire   [31:0] f2sdram_only_master1_master_translator_avalon_universal_master_0_address;       // f2sdram_only_master1_master_translator:uav_address -> f2sdram_only_master1_master_agent:av_address
	wire          f2sdram_only_master1_master_translator_avalon_universal_master_0_read;          // f2sdram_only_master1_master_translator:uav_read -> f2sdram_only_master1_master_agent:av_read
	wire    [3:0] f2sdram_only_master1_master_translator_avalon_universal_master_0_byteenable;    // f2sdram_only_master1_master_translator:uav_byteenable -> f2sdram_only_master1_master_agent:av_byteenable
	wire          f2sdram_only_master1_master_translator_avalon_universal_master_0_readdatavalid; // f2sdram_only_master1_master_agent:av_readdatavalid -> f2sdram_only_master1_master_translator:uav_readdatavalid
	wire          f2sdram_only_master1_master_translator_avalon_universal_master_0_lock;          // f2sdram_only_master1_master_translator:uav_lock -> f2sdram_only_master1_master_agent:av_lock
	wire          f2sdram_only_master1_master_translator_avalon_universal_master_0_write;         // f2sdram_only_master1_master_translator:uav_write -> f2sdram_only_master1_master_agent:av_write
	wire   [31:0] f2sdram_only_master1_master_translator_avalon_universal_master_0_writedata;     // f2sdram_only_master1_master_translator:uav_writedata -> f2sdram_only_master1_master_agent:av_writedata
	wire    [2:0] f2sdram_only_master1_master_translator_avalon_universal_master_0_burstcount;    // f2sdram_only_master1_master_translator:uav_burstcount -> f2sdram_only_master1_master_agent:av_burstcount
	wire          f2sdram_only_master1_master_agent_cp_valid;                                     // f2sdram_only_master1_master_agent:cp_valid -> router:sink_valid
	wire  [119:0] f2sdram_only_master1_master_agent_cp_data;                                      // f2sdram_only_master1_master_agent:cp_data -> router:sink_data
	wire          f2sdram_only_master1_master_agent_cp_ready;                                     // router:sink_ready -> f2sdram_only_master1_master_agent:cp_ready
	wire          f2sdram_only_master1_master_agent_cp_startofpacket;                             // f2sdram_only_master1_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          f2sdram_only_master1_master_agent_cp_endofpacket;                               // f2sdram_only_master1_master_agent:cp_endofpacket -> router:sink_endofpacket
	wire          router_src_valid;                                                               // router:src_valid -> f2sdram_only_master1_master_limiter:cmd_sink_valid
	wire  [119:0] router_src_data;                                                                // router:src_data -> f2sdram_only_master1_master_limiter:cmd_sink_data
	wire          router_src_ready;                                                               // f2sdram_only_master1_master_limiter:cmd_sink_ready -> router:src_ready
	wire    [1:0] router_src_channel;                                                             // router:src_channel -> f2sdram_only_master1_master_limiter:cmd_sink_channel
	wire          router_src_startofpacket;                                                       // router:src_startofpacket -> f2sdram_only_master1_master_limiter:cmd_sink_startofpacket
	wire          router_src_endofpacket;                                                         // router:src_endofpacket -> f2sdram_only_master1_master_limiter:cmd_sink_endofpacket
	wire          f2sdram_only_master1_master_limiter_rsp_src_valid;                              // f2sdram_only_master1_master_limiter:rsp_src_valid -> f2sdram_only_master1_master_agent:rp_valid
	wire  [119:0] f2sdram_only_master1_master_limiter_rsp_src_data;                               // f2sdram_only_master1_master_limiter:rsp_src_data -> f2sdram_only_master1_master_agent:rp_data
	wire          f2sdram_only_master1_master_limiter_rsp_src_ready;                              // f2sdram_only_master1_master_agent:rp_ready -> f2sdram_only_master1_master_limiter:rsp_src_ready
	wire    [1:0] f2sdram_only_master1_master_limiter_rsp_src_channel;                            // f2sdram_only_master1_master_limiter:rsp_src_channel -> f2sdram_only_master1_master_agent:rp_channel
	wire          f2sdram_only_master1_master_limiter_rsp_src_startofpacket;                      // f2sdram_only_master1_master_limiter:rsp_src_startofpacket -> f2sdram_only_master1_master_agent:rp_startofpacket
	wire          f2sdram_only_master1_master_limiter_rsp_src_endofpacket;                        // f2sdram_only_master1_master_limiter:rsp_src_endofpacket -> f2sdram_only_master1_master_agent:rp_endofpacket
	...
	wire    [0:0] f2sdram_only_master1_master_limiter_cmd_src_valid;                              // f2sdram_only_master1_master_limiter:cmd_src_valid -> limiter_pipeline:in_valid
	wire  [119:0] f2sdram_only_master1_master_limiter_cmd_src_data;                               // f2sdram_only_master1_master_limiter:cmd_src_data -> limiter_pipeline:in_data
	wire          f2sdram_only_master1_master_limiter_cmd_src_ready;                              // limiter_pipeline:in_ready -> f2sdram_only_master1_master_limiter:cmd_src_ready
	wire    [1:0] f2sdram_only_master1_master_limiter_cmd_src_channel;                            // f2sdram_only_master1_master_limiter:cmd_src_channel -> limiter_pipeline:in_channel
	wire          f2sdram_only_master1_master_limiter_cmd_src_startofpacket;                      // f2sdram_only_master1_master_limiter:cmd_src_startofpacket -> limiter_pipeline:in_startofpacket
	wire          f2sdram_only_master1_master_limiter_cmd_src_endofpacket;                        // f2sdram_only_master1_master_limiter:cmd_src_endofpacket -> limiter_pipeline:in_endofpacket
	...
	wire          limiter_pipeline_001_source0_valid;                                             // limiter_pipeline_001:out_valid -> f2sdram_only_master1_master_limiter:rsp_sink_valid
	wire  [119:0] limiter_pipeline_001_source0_data;                                              // limiter_pipeline_001:out_data -> f2sdram_only_master1_master_limiter:rsp_sink_data
	wire          limiter_pipeline_001_source0_ready;                                             // f2sdram_only_master1_master_limiter:rsp_sink_ready -> limiter_pipeline_001:out_ready
	wire    [1:0] limiter_pipeline_001_source0_channel;                                           // limiter_pipeline_001:out_channel -> f2sdram_only_master1_master_limiter:rsp_sink_channel
	wire          limiter_pipeline_001_source0_startofpacket;                                     // limiter_pipeline_001:out_startofpacket -> f2sdram_only_master1_master_limiter:rsp_sink_startofpacket
	wire          limiter_pipeline_001_source0_endofpacket;                                       // limiter_pipeline_001:out_endofpacket -> f2sdram_only_master1_master_limiter:rsp_sink_endofpacket
	...
	) f2sdram_only_master1_master_translator (
		.clk                    (clk_0_clk_clk),                                                                  //                       clk.clk
		.reset                  (arria10_hps_0_f2sdram0_reset_reset_bridge_in_reset_reset),                       //                     reset.reset
		.uav_address            (f2sdram_only_master1_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (f2sdram_only_master1_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (f2sdram_only_master1_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (f2sdram_only_master1_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (f2sdram_only_master1_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (f2sdram_only_master1_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (f2sdram_only_master1_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (f2sdram_only_master1_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (f2sdram_only_master1_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (f2sdram_only_master1_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (f2sdram_only_master1_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (f2sdram_only_master1_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (f2sdram_only_master1_master_waitrequest),                                        //                          .waitrequest
		.av_byteenable          (f2sdram_only_master1_master_byteenable),                                         //                          .byteenable
		.av_read                (f2sdram_only_master1_master_read),                                               //                          .read
		.av_readdata            (f2sdram_only_master1_master_readdata),                                           //                          .readdata
		.av_readdatavalid       (f2sdram_only_master1_master_readdatavalid),                                      //                          .readdatavalid
		.av_write               (f2sdram_only_master1_master_write),                                              //                          .write
		.av_writedata           (f2sdram_only_master1_master_writedata),                                          //                          .writedata
	...
	altera_merlin_master_agent #(
		...
		.av_address            (f2sdram_only_master1_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (f2sdram_only_master1_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (f2sdram_only_master1_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (f2sdram_only_master1_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (f2sdram_only_master1_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (f2sdram_only_master1_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (f2sdram_only_master1_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (f2sdram_only_master1_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (f2sdram_only_master1_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (f2sdram_only_master1_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (f2sdram_only_master1_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (f2sdram_only_master1_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (f2sdram_only_master1_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (f2sdram_only_master1_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (f2sdram_only_master1_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (f2sdram_only_master1_master_agent_cp_ready),                                     //          .ready
		.rp_valid              (f2sdram_only_master1_master_limiter_rsp_src_valid),                              //        rp.valid
		.rp_data               (f2sdram_only_master1_master_limiter_rsp_src_data),                               //          .data
		.rp_channel            (f2sdram_only_master1_master_limiter_rsp_src_channel),                            //          .channel
		.rp_startofpacket      (f2sdram_only_master1_master_limiter_rsp_src_startofpacket),                      //          .startofpacket
		.rp_endofpacket        (f2sdram_only_master1_master_limiter_rsp_src_endofpacket),                        //          .endofpacket
		.rp_ready              (f2sdram_only_master1_master_limiter_rsp_src_ready),                              //          .ready
		.av_response           (),                                                                               // (terminated)
		.av_writeresponsevalid ()                                                                                // (terminated)
	);
	...
	ghrd_10as066n2_altera_merlin_router_160_g2elu7i router (
		.sink_ready         (f2sdram_only_master1_master_agent_cp_ready),               //      sink.ready
		.sink_valid         (f2sdram_only_master1_master_agent_cp_valid),               //          .valid
		.sink_data          (f2sdram_only_master1_master_agent_cp_data),                //          .data
		.sink_startofpacket (f2sdram_only_master1_master_agent_cp_startofpacket),       //          .startofpacket
		.sink_endofpacket   (f2sdram_only_master1_master_agent_cp_endofpacket),         //          .endofpacket
		.clk                (clk_0_clk_clk),                                            //       clk.clk
		.reset              (arria10_hps_0_f2sdram0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_traffic_limiter #(
		...
		.REORDER                   (0)
	) f2sdram_only_master1_master_limiter (
		.clk                    (clk_0_clk_clk),                                             //       clk.clk
		.reset                  (arria10_hps_0_f2sdram0_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
		...
		.cmd_src_ready          (f2sdram_only_master1_master_limiter_cmd_src_ready),         //   cmd_src.ready
		.cmd_src_data           (f2sdram_only_master1_master_limiter_cmd_src_data),          //          .data
		.cmd_src_channel        (f2sdram_only_master1_master_limiter_cmd_src_channel),       //          .channel
		.cmd_src_startofpacket  (f2sdram_only_master1_master_limiter_cmd_src_startofpacket), //          .startofpacket
		.cmd_src_endofpacket    (f2sdram_only_master1_master_limiter_cmd_src_endofpacket),   //          .endofpacket
		.cmd_src_valid          (f2sdram_only_master1_master_limiter_cmd_src_valid),         //          .valid
		...
		.rsp_src_ready          (f2sdram_only_master1_master_limiter_rsp_src_ready),         //   rsp_src.ready
		.rsp_src_valid          (f2sdram_only_master1_master_limiter_rsp_src_valid),         //          .valid
		.rsp_src_data           (f2sdram_only_master1_master_limiter_rsp_src_data),          //          .data
		.rsp_src_channel        (f2sdram_only_master1_master_limiter_rsp_src_channel),       //          .channel
		.rsp_src_startofpacket  (f2sdram_only_master1_master_limiter_rsp_src_startofpacket), //          .startofpacket
		.rsp_src_endofpacket    (f2sdram_only_master1_master_limiter_rsp_src_endofpacket)    //          .endofpacket
	);
	...
	altera_avalon_st_pipeline_stage #(
		...
		.in_ready          (f2sdram_only_master1_master_limiter_cmd_src_ready),         //     sink0.ready
		.in_valid          (f2sdram_only_master1_master_limiter_cmd_src_valid),         //          .valid
		.in_startofpacket  (f2sdram_only_master1_master_limiter_cmd_src_startofpacket), //          .startofpacket
		.in_endofpacket    (f2sdram_only_master1_master_limiter_cmd_src_endofpacket),   //          .endofpacket
		.in_data           (f2sdram_only_master1_master_limiter_cmd_src_data),          //          .data
		.in_channel        (f2sdram_only_master1_master_limiter_cmd_src_channel),       //          .channel
