...
module ghrd_10as066n2_altera_merlin_router_161_glc2kaq_default_decode
  #(
...
module ghrd_10as066n2_altera_merlin_router_161_glc2kaq
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    ghrd_10as066n2_altera_merlin_router_161_glc2kaq_default_decode the_default_decode(
    ...
    // ( 0x50000 .. 0x60000 )
    if ( {address[RG:PAD1],{PAD1{1'b0}}} == 19'h50000  && write_transaction  ) begin
            src_channel = 3'b01;
