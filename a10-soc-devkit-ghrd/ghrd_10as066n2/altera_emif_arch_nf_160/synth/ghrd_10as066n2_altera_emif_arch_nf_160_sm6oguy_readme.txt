...
------------------------
   ...
   This is the readme file for the Altera External Memory Interface (EMIF) IP v16.0.
...
--------------------
   ...
   MEM_DDR4_RDIMM_CONFIG                             : 0
   MEM_DDR4_LRDIMM_EXTENDED_CONFIG                   : 0x0
