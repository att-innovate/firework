...
# ----------------------------------------
# If varint_in_size is one of several IP cores in your
...
# ----------------------------------------
# ACDS 17.1 590 linux 2017.12.05.15:03:40
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "varint_in_size"
}
...
ensure_lib                         ./libraries/varint_in_size_fifo_171/
vmap       varint_in_size_fifo_171 ./libraries/varint_in_size_fifo_171/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../fifo_171/sim/varint_in_size_fifo_171_i6uzucq.v" -work varint_in_size_fifo_171
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/varint_in_size.v"                                                               
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L varint_in_size_fifo_171 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L varint_in_size_fifo_171 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
