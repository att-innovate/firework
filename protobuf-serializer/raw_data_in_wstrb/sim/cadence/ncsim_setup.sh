...
TOP_LEVEL_NAME="raw_data_in_wstrb"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/raw_data_in_wstrb_fifo_171/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../fifo_171/sim/raw_data_in_wstrb_fifo_171_ke7pjxy.v" -work raw_data_in_wstrb_fifo_171 -cdslib ./cds_libs/raw_data_in_wstrb_fifo_171.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/raw_data_in_wstrb.v"                                                                                                                        
fi
