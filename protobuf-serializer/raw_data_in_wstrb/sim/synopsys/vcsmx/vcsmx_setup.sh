...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../fifo_160/sim/raw_data_in_wstrb_fifo_160_sconavq.v" -work raw_data_in_wstrb_fifo_160
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/raw_data_in_wstrb.v"                                                                  
fi
