...
# ----------------------------------------
# If raw_data_in_fifo is one of several IP cores in your
...
# ----------------------------------------
# ACDS 17.1 590 linux 2017.12.05.15:04:47
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "raw_data_in_fifo"
}
...
ensure_lib                           ./libraries/raw_data_in_fifo_fifo_171/
vmap       raw_data_in_fifo_fifo_171 ./libraries/raw_data_in_fifo_fifo_171/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../fifo_171/sim/raw_data_in_fifo_fifo_171_ad2l2zy.v" -work raw_data_in_fifo_fifo_171
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/raw_data_in_fifo.v"                                                                 
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L raw_data_in_fifo_fifo_171 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L raw_data_in_fifo_fifo_171 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
