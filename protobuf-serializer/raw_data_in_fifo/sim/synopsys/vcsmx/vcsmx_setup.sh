...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../fifo_171/sim/raw_data_in_fifo_fifo_171_ad2l2zy.v" -work raw_data_in_fifo_fifo_171
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/raw_data_in_fifo.v"                                                                 
fi
