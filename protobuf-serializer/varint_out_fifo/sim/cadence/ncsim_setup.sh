...
TOP_LEVEL_NAME="varint_out_fifo"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/varint_out_fifo_fifo_171/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../fifo_171/sim/varint_out_fifo_fifo_171_u2h7cyi.v" -work varint_out_fifo_fifo_171 -cdslib ./cds_libs/varint_out_fifo_fifo_171.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/varint_out_fifo.v"                                                                                                                    
fi
