...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../fifo_160/sim/varint_out_fifo_fifo_160_q2auapq.v" -work varint_out_fifo_fifo_160 -cdslib ./cds_libs/varint_out_fifo_fifo_160.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/varint_out_fifo.v"                                                                                                                    
fi
