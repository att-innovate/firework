...
TOP_LEVEL_NAME="varint_in_index"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/varint_in_index_fifo_171/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../fifo_171/sim/varint_in_index_fifo_171_sdxy63a.v" -work varint_in_index_fifo_171 -cdslib ./cds_libs/varint_in_index_fifo_171.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/varint_in_index.v"                                                                                                                    
fi
