...
mkdir -p ./libraries/out_fifo_fifo_171/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../fifo_171/sim/out_fifo_fifo_171_onw3uty.v" -work out_fifo_fifo_171 -cdslib ./cds_libs/out_fifo_fifo_171.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/out_fifo.v"                                                                                                      
fi
