...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../fifo_160/sim/out_fifo_fifo_160_r4prduy.v" -work out_fifo_fifo_160 -cdslib ./cds_libs/out_fifo_fifo_160.cds.lib
