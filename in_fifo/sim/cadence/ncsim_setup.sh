...
mkdir -p ./libraries/in_fifo_fifo_160/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../fifo_160/sim/in_fifo_fifo_160_mnfmh2i.v" -work in_fifo_fifo_160 -cdslib ./cds_libs/in_fifo_fifo_160.cds.lib
  ncvlog -compcnfg $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/in_fifo.v"                                                                                                    
fi
